...
//#region node_modules/@barba/core/dist/barba.umd.js
var require_barba_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, n) {
		...
		function n(n, r, i) {
			return r && t(n.prototype, r), i && t(n, i), Object.defineProperty(n, "prototype", { writable: !1 }), n;
		}
		function r() {
			...
			return i.init = function(t, n) {
				...
				switch (e) {
					case "push":
						...
						break;
					case "replace": this.set(this.P, o);
				}
				var u = {
					from: this.p,
					index: this.P,
				...
				switch (e) {
					case "push":
						...
						break;
					case "replace": window.history && window.history.replaceState(u, "", t);
				}
				...
				var r = function() {
					if (!n.next.html) return Promise.resolve(t).then(function(t) {
						...
						if (t) {
							...
							r.namespace = b.getNamespace(i), r.container = b.getContainer(i), r.url = t.url, r.html = t.html, P.update({ ns: r.namespace });
		...
		function M(t, n, i, e, o) {
			return void 0 === n && (n = 2e3), new Promise(function(u, s) {
				...
				f.onreadystatechange = function() {
					...
					var r = /* @__PURE__ */ new Error("Timeout error [" + n + "]");
					i(t, r), s(r), e.update(t, { status: "rejected" });
				}, f.onerror = function() {
					var n = /* @__PURE__ */ new Error("Fetch error");
		...
		var L = new (/* @__PURE__ */ function(t) {
			function n() {
				...
				return (n = t.call(this) || this).logger = new d("@barba/core"), n.all = [
					...
					"afterEnter",
					"after"
				], n.registered = /* @__PURE__ */ new Map(), n.init(), n;
			}
			i(n, t);
			var r = n.prototype;
			return r.init = function() {
				...
				this.registered.clear(), this.all.forEach(function(n) {
					t[n] || (t[n] = function(r, i) {
						t.registered.has(n) || t.registered.set(n, /* @__PURE__ */ new Set()), t.registered.get(n).add({
							ctx: i || {},
							fn: r
						});
					});
			...
			function n(n) {
				var r;
				return (r = t.call(this, n) || this).T = /* @__PURE__ */ new Map(), r;
			}
			i(n, t);
			var e = n.prototype;
			...
			function n(n) {
				var r;
				return (r = t.call(this, n) || this).suite = [], r.tests = /* @__PURE__ */ new Map(), r.init(), r;
			}
			i(n, t);
			var r = n.prototype;
			return r.init = function() {
			...
			return n.add = function(t, n) {
				...
				var e = /* @__PURE__ */ new Map(), o = i.find(function(i) {
					var o = !0, u = {};
		...
		var Y = /*#__PURE__*/ function() {
			...
			function t(t) {
				...
				this.names = [
					...
					"beforeEnter",
					"afterEnter"
				], this.byNamespace = /* @__PURE__ */ new Map(), 0 !== t.length && (t.forEach(function(t) {
		...
		return new (/* @__PURE__ */ function() {
			...
			return i.use = function(t, n) {
				...
				try {
					...
					if (s.data.next.url = r({ href: t }, s.url.parse(t)), s.data.trigger = n, s.data.event = i, s.cache.has(t)) o = s.cache.update(t, { action: "click" }).request;
					else {
...
//#endregion
export default require_barba_umd();
